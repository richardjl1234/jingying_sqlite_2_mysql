"""
Load category 1 codes from Excel file to MySQL database.
This program reads cat1_code.xlsx and uploads the data to the process_cat1 table.
"""
...
def main():
    """
    Main function to load category 1 data from Excel to MySQL.
    """
    # File configuration
    excel_file = "cat1_code.xlsx"
    ...
    try:
        ...
        print(f"Renamed columns to: cat1_code, name")
